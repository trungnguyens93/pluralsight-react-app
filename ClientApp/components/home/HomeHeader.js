        ...
        <div className="row">
          ...
          <div className="col-12 col-sm-8">
            ...
            <div className="jumbo-events__description">
              ...
              learn from fellow developers. We also have developer related
              topics that include software branding, legal issues around
              software as well as other topics developers are interested in
              hearing about.
            </div>
